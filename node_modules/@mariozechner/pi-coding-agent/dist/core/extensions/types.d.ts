...
export type SessionEvent = SessionDirectoryEvent | SessionStartEvent | SessionBeforeSwitchEvent | SessionSwitchEvent | SessionBeforeForkEvent | SessionForkEvent | SessionBeforeCompactEvent | SessionCompactEvent | SessionShutdownEvent | SessionBeforeTreeEvent | SessionTreeEvent;
...
export type SessionDirectoryHandler = (event: SessionDirectoryEvent) => Promise<SessionDirectoryResult | undefined> | SessionDirectoryResult | undefined;
